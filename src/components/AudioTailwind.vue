<template>
  ...
  <div class="w-full main">
    <div class="flex items-center justify-center h-screen bg-red-lightest">
      <div class="bg-white shadow-lg rounded-lg p-2" style="width: 90rem !important; ">
        <div>
          <h3 class="text-2xl text-grey-darkest font-medium">Ghost Stories</h3>
        </div>
        <div class="w-full">
          <div class="flex justify-between items-center">
            <div>
              <img class="h-20 w-20 rounded-full" src="https://tailwindcss.com/img/card-top.jpg" alt="Album Pic">
            </div>
        ...
        <div class="mx-8"> <!-- progress bar -->
          <div class="flex justify-between items-center text-sm text-grey-darker">
            <p>0:40</p>
            <div class="border-2 border-black-600 h-2 w-full mx-2">
              <div class=" h-1 bg-black block" :style="styleData"></div>
            </div>
            <p>4:20</p>
          </div>
        </div>
