<template>
  <div class="player">
    <div class="player-controls">
      ...
      <div id="play">
        <a @click.prevent="playing = !playing" :title="(playing) ? 'Pause' : 'Play'" href="#">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <div id="seek">
        ...
        <div class="player-time">
          <div class="player-time-current">{{ convertTimeHHMMSS(this.currentSeconds) }}</div>
          <div class="player-time-total">{{ convertTimeHHMMSS(this.durationSeconds) }}</div>
        </div>
      </div>
      ...
      <div id="loop" v-show="!showVolume">
        <a @click.prevent="looping = !looping" href="#" title="Loop">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <div id="volume">
        <a @click.prevent="" @mouseenter="showVolume = true" @mouseleave="showVolume = false"
    ...
    <audio :loop="looping" ref="audio" :src="file" @timeupdate="update" @loadeddata="load"
           @pause="playing = false" @play="playing = true" preload="auto" style="display: none;"></audio>
  </div>
</template>
